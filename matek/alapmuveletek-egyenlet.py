...
def main():
    parser = argparse.ArgumentParser(description='Alapműveletek gyakorlása a hiányzó számok megkeresésvel.')
    ...
    parser.add_argument('--operations', type=str, default='+,-,*,/', help='Megengedett alapműveletek vesszővel elválasztva (+,-,*,/).')
